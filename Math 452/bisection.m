...
FP = F(P)
if FLAG == 2
fprintf(OUP, '%3d   %15.10e   %15.10e \n', I, P, FP)
end
if abs(FP) < 1.0e-20 | C < TOL
% procedure completed successfully
fprintf(OUP, '\nApproximate solution P = %11.10f \n', P)
fprintf(OUP, 'with F(P) = %12.10f\n', FP)
fprintf(OUP, 'Number of iterations = %3d', I)
fprintf(OUP, ' Tolerance = %15.10e\n', TOL)
OK = FALSE
else
% STEP 5
I = I+1
...
fprintf(OUP, ' gave approximation %12.10f\n', P)
fprintf(OUP, 'F(P) = %12.10f not within tolerance : %15.10e\n', FP, TOL)
end
if OUP ~ = 1
fclose(OUP)
